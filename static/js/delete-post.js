        ...
        fetch(url + 'delete', {
            ...
            .then(data => {
                if (data.status === 200) {
                    ...
                    posts.innerHTML = '<h3 style="color: red">POST DELETED</h2><br><br><a href="/" style="text-decoration: none"><img src="/svgs/SHIELD-logo.svg" class="small-icon"> <b>Homepage<b></a>'
