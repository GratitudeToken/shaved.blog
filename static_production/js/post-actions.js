...
import { voteBTN } from '/shield/js/vote.js'
import { deletePost } from '/shield/js/delete-post.js'
import { countdown } from '/shield/js/countdown.js'
import { commentEvents } from '/shield/js/comments.js'
export let filter
            ...
            .then(data => {
                ...
                const postFunctions = (item, index) => {
                    ...
                    if (populatePosts === true) {
                        ...
                        if (typeof queryURL === 'string' || queryURL.type === 'search' || queryURL.type === 'tag') {
                            html = new indexHTML
                        } else {
                            html = new HTML
                            indexPage = false
